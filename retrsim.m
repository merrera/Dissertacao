...
QBj(1) = 12.53;
QBj(2) =  5.70;
% Qji consumo de presa (i) pelo predador (j) ton(i)/km2/ano
for j = 1:Ngrupos,   
    for i = 1:Ngrupos,
...
PBj (1) = 1.5; % Hopmal J
PBj (2) = 0.9; % Hopmal A
% EEj - eficiencia ecotr?fica do grupo (j)  ( 0 <= EE <= 1)
EEj (1) = 0.723; % Hopmal J
EEj (2) = 0.138; % Hopma A
% M0j  - mortalidade espont?nea de biomassa do grupo (j) tonBM/tonB/ano 
for j = 1:Ngrupos,
